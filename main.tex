...
% Test bib
\cite{batch_normalization, normalizing_flows, kernel_tsne, parametric_tsne, tsne, accelerated_tsne, stochastic_backpropagation, aevb, affinity_propagation, critical_assessment, phenograph, visne, flowmeans, householder_flow, inverse_autoregressive_flow, trustworthiness, umap, mnist, relu, xavier_initializer, pca_first, pca_second, mass_cytometry, gan}
