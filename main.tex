...
\usetikzlibrary{bayesnet, patterns, decorations.pathreplacing}
...
% Test bib
\cite{batch_normalization, normalizing_flows, kernel_tsne, parametric_tsne, tsne, stochastic_backpropagation, aevb, affinity_propagation, critical_assessment, phenograph, visne, flowmeans, householder_flow, inverse_autoregressive_flow, trustworthiness, umap, mnist, relu, xavier_initializer, pca_first, pca_second, mass_cytometry, gan, how_batch_norm_works, accelerated_tsne_1, accelerated_tsne_2, stochastic_triplet_embedding, sne}
