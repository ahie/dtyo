...
\note{Add the more practical explanation, which relates back to compression: $\dkl{p}{q}$ determines the average additional bits needed for compression if $q$ is used as a surrogate for $p$.}
