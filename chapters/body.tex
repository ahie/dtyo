...
\note{Problem with variational inference, also apparent in our Gaussian encoder example here, is the inflexibility of the chosen distribution. Normalizing flows attempt to resolve this issue \cite{normalizing_flows, inverse_autoregressive_flow, householder_flow}, result in overall better $p(\mathbf{x})$, and with VAE these flows can be learned efficiently.}
