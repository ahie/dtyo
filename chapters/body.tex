...
With such a high dimensional data set, the effect of the curse of dimensionality can be seen on methods based on distances, leading them to produce inferior embeddings. For example, applying UMAP directly to the high dimensional data one of the most obvious shortcomings of the embedding is its failure to distinguish between T- and B-cells. A figure of the UMAP embedding is included in Appendix~\ref{appendix:umap_tirosh} for comparison.
