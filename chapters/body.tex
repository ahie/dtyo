...
To tackle problems associated with high dimensional data, a common approach is to seek for a lower dimensional representation of the data which retains its salient features. As a key research area in the field of machine learning, dimensionality reduction is 
