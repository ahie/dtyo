...
In literature, problems arising from high dimensionality are collectively referred to as the \textit{curse of dimensionality}, a term first coined by Richard Bellman in the context of his work in dynamic programming \cite{bellman_curse_of_dimensionality}. Particularly in machine learning the following aspects of high dimensional data pose 
...
To tackle problems associated with high dimensional data a common approach is to seek for a lower dimensional representation of the data which retains the salient features of the data. This process, known as dimensionality reduction, can be split into two different approaches. 
...
A key component of the method presented in this work are Variational Autoencoders (VAEs). VAEs belong to a broad class of models called deep generative models, which have in recent years played a pivotal role in research ... . 
