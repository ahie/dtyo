...
\note{How this is practically optimized, introduce the concept of ELBO (main point: Equation~\ref{eq:vi} cannot be directly optimized since that would require evaluation of the posterior itself)}
